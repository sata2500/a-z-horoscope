  ...
  return (
    <div className="container max-w-4xl py-12">
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <p className="text-foreground dark:text-gray-200">
          Bu haklarınızı kullanmak için <Link href="mailto:support@az-horoscope.com" className="text-primary hover:underline dark:text-blue-400">support@az-horoscope.com</Link> adresinden bizimle iletişime geçebilirsiniz.
        </p>
